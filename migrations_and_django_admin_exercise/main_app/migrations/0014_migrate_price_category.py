# Generated by Django 5.0.4 on 2024-06-26 16:20
...
def set_reverse_fulling_of_columns_category_and_price(apps, schema_editor):
    smartphone_model = apps.get_model('main_app', 'Smartphone')
    for smartphone in smartphone_model.objects.all():
...
def set_all_columns(apps, schema_editor):  # To combine the two functions
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(set_all_columns, set_reverse_fulling_of_columns_category_and_price)
    ]
