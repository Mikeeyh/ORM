...
class Task(models.Model):
    ...
    def ongoing_high_priority_tasks(cls) -> QuerySet:
        return cls.objects.filter(
            ...
            # we use 'F' because we take the 'completion_date' and make comparison to 'creation_date' of the same object
        )
    ...
    def recent_completed_tasks(cls, days: int):
        return cls.objects.filter(
            ...
            # using timedelta because we should convert days (int) to date format
        )
